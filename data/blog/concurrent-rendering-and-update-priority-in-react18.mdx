...
Here is an excellent tools for visualizing the React rendering process:\
https://jser.pro/ddir/rie?reactVersion=18.3.1&snippetKey=kh4bue0mjb89xz73vnr
![counter-update-animation](/static/images/posts/concurrent-rendering-and-update-priority-in-react18/counter-update-animation.gif)

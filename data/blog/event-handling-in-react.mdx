...
draft: false
summary: 'In React, event handling is a bit different from traditional DOM manipulation. React wraps events in synthetic events, which provide a consistent interface across different browsers.'
images: []
---

## Introduction
In React, event handling is a bit different from traditional DOM manipulation. React wraps events in synthetic events, which provide a consistent interface across different browsers. This means you don't have to worry about cross-browser compatibility issues when working with events in React.
